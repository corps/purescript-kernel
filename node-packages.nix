...
let
  sources = {
    ...
    "@types/node-8.5.10" = {
      ...
      version = "8.5.10";
      src = fetchurl {
        url = "https://registry.npmjs.org/@types/node/-/node-8.5.10.tgz";
        sha512 = "2wqiaww2n7zgsynam7br0n3dafsjkgw650bc1hkc0qhhxxhz3n6y7svvgxm6skc4kg59arhpd995rf68f98w9r6rm21d0ji70p3ks8f";
      };
    };
    "@types/webpack-3.8.5" = {
      ...
      version = "3.8.5";
      src = fetchurl {
        url = "https://registry.npmjs.org/@types/webpack/-/@types/webpack-3.8.5.tgz";
        sha512 = "3dhqrqsrmpff128bnw1ml1iavbr7a33hcpqkppn6kl0szhpzk8ds6dalb8a3xlbj1gs1nwv56jczdjvx5yig7s339rzrw3ad2rn5d32";
      };
    };
    "jmp-0.7.6" = {
      name = "jmp";
    ...
    "node-abi-2.2.0" = {
      ...
      version = "2.2.0";
      src = fetchurl {
        url = "https://registry.npmjs.org/node-abi/-/node-abi-2.2.0.tgz";
        sha512 = "366wrbwahpibg107sp38k2yiylnb5fhq2jgr540ddar83838a7qnphxpgxbjbs220i24vc3j9fikz29qj21kdq2b78cfbsdcg8l598n";
      };
    };
    "noop-logger-0.1.1" = {
      name = "noop-logger";
  ...
  args = {
    name = "purescript-webpack-kernel";
    packageName = "purescript-webpack-kernel";
    version = "1.0.0";
    src = ./.;
    dependencies = [
      sources."@types/memory-fs-0.3.0"
      sources."@types/node-8.5.10"
      sources."@types/webpack-3.8.5"
      sources."jmp-0.7.6"
    ...
    meta = {
      description = "Purescript + webpack jupyter kernel";
      homepage = "https://github.com/corps/purescript-webpack-kernel#readme";
      license = "MIT";
    };
    production = true;
  };
